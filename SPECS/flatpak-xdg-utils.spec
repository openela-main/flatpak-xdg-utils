...
%changelog
* Tue Apr 05 2022 Debarshi Ray <rishi@fedoraproject.org> - 1.0.5-1
- Update to 1.0.5
- Enable installed tests
Resolves: #2068332

* Fri Feb 05 2021 Kalev Lember <klember@redhat.com> - 1.0.4-4
...
* Fri Feb 05 2021 Tomas Pelka <tpelka@redhat.com> - 1.0.4-2
- Bumb release version and rebuild due to missing gating.yaml
